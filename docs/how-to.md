...
- Карточки лучше **майнить**. **Майнинг** - создание флешкарточки прямо из контента, который вы потребляете, копируя оттуда контекст. Это можно и нужно делать автоматизированно, как это было показано на видео в начале статьи. Замайненные карточки учатся легче, а также ваше понимание слов, которые вы встретили в реальном контексте - гораздо лучше. 
...
- **Textractor** - программа для вытаскивания текста из визуальных новел, чтобы их можно было подсматривать с помощью **Yomichan\JL** и делать флешкарточки. Также есть некоторые аналоги, подробнее в статье про ВН (в работе).
