...
:::
| Браузер  |Формат карточки |
| ------------- | ------------- |
| ![браузер](public/browser.png)   |![формат карточки](public/format.png)  |
