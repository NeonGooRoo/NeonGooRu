...
Если **Anki** уже скачан, удостовертьесь, что вы на последней версии!
...
Скачайте [данный архив](https://drive.google.com/file/d/12ZcaSywKkwHSqPTrTgMC4VT__FYa43i5/view?usp=drive_link) с аддонами, и перенесите папку `Addons21`
...
на лицевой стороне у вас будет только слово, которое вам нужно вспомнить. Если вам нужна для этого слова подсказка, нажмите на **E**, у вас откроются поля карточки, и найдите и заполните поля `Hint` (подсказка скрытая, котрывается по нажатию) или `HintNotHidden` (подсказка, которую видно сразу). Если вам неудобно каждый раз искать поле, нажмите **"поля"**, выбирете нужное поле и нажмите **"переместить"**, выбрав значение 2 или 3, 1 не стоит. На задней стороне карточки вы будете видеть слово, чтение в виде фуриганы, все ваши словари (заполнены по приориитету, который был в Yomitan), а также есть дополнительная информация, где можно посмотреть больше инфы о слове на **JPDB**, **Jisho** и **Google Images**.
...
Ни в коем случае не забывайте про питчи! Их необязательно страться запоминать наизусть и считать карточку забытой, если она не вспомнилась, но нужно пытатсья обращать на него внимание, слышать и повторять в голове, хотя бы.
