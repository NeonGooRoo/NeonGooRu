...
Тут будет показано какой софт существует и как его использовать для более эффективного изучения Японского языка. Инструкция по изначальная настройка и использованию каждой программы будет находится на отдельной странице в приложенной ссылке в оглавии.
...
Также многие игры могут некорректно работать не на японской локали, для этого есть **Locale Emulator**.
...
[Подробнее о настройке и использовании тут.](/ocr-tools.md)

## [Mokuro](/mokuro.md)

**Mokuro** - cамая лучшая программа для сканирования манги в превращения ее в формат, пробиваемый через **Yomichan**
