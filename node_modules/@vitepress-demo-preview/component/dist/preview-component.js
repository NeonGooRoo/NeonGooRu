import { openBlock as a, createElementBlock as p, createElementVNode as i, ref as _, defineComponent as $, watch as b, createBlock as y, Transition as R, withCtx as P, normalizeClass as r, unref as o, normalizeStyle as j, createVNode as x, toDisplayString as k, createCommentVNode as H, createApp as O, computed as B, onMounted as A, renderSlot as T } from "vue";
const Z = (t, n) => {
...
function Ce(t, n) {
  return a(), p("svg", re, de);
}
const pe = /* @__PURE__ */ Z(le, [["render", Ce]]), _e = /* @__PURE__ */ $({
  ...
  setup(t, { expose: n }) {
    ...
    return n({
      ...
      default: P(() => [
        l.value ? (a(), p("div", {
          key: 0,
          class: r([o(c).bem("message-notice", "container")]),
          style: j({ top: h.value + "px" })
        }, [
          x(pe),
          i("span", null, k(t.content), 1)
        ], 6)) : H("", !0)
      ]),
      _: 1
    }));
...
const V = [], E = {
  open: () => {
    const t = document.createElement("div"), n = O(_e, {
      content: "\u590D\u5236\u6210\u529F\uFF01",
      close: () => {
    ...
    e.setTopHeight(l), e.setVisible(!0), V.push(e);
  }
}, ve = ["innerHTML"], he = ["innerHTML"], fe = /* @__PURE__ */ $({
  __name: "AntDesign",
  props: {
    code: null,
    showCode: null,
  ...
  setup(t) {
    const n = t, e = F(), { isCodeFold: c, setCodeFold: l } = S(), { copyContent: v, clickCopy: h } = U(), m = _(decodeURIComponent(n.code)), C = _(decodeURIComponent(n.showCode)), d = _(null), L = () => {
      h(m.value), E.open();
    }, g = B(() => {
      var u;
    ...
    return A(() => {
      ...
      class: r([o(e).e("ant-design__container")])
    }, [
      i("section", {
        class: r([o(e).bem("preview")])
      }, [
        T(u.$slots, "default")
      ], 2),
      i("section", {
        class: r([o(e).bem("description")])
      }, [
        n.title ? (a(), p("div", {
          key: 0,
          class: r([o(e).bem("description", "title")])
        }, k(t.title), 3)) : H("", !0),
        n.description ? (a(), p("div", {
          key: 1,
          class: r([o(e).bem("description", "content")]),
          innerHTML: t.description
        }, null, 10, ve)) : H("", !0),
        n.description || !n.title && !n.description ? (a(), p("div", {
          key: 2,
          class: r([o(e).bem("description", "split-line")])
        }, null, 2)) : H("", !0),
        i("div", {
          class: r([o(e).bem("description", "handle-btn")])
        }, [
          o(c) ? (a(), y(N, {
            key: 1,
            onClick: f[1] || (f[1] = (z) => o(l)(!1))
          })) : (a(), y(I, {
            key: 0,
            onClick: f[0] || (f[0] = (z) => o(l)(!0))
          })),
          x(D, { onClick: L })
        ], 2)
      ], 2),
      i("section", {
        class: r([o(e).bem("source")]),
...
const me = ["innerHTML"], ye = /* @__PURE__ */ $({
  __name: "ElementPlus",
  props: {
    code: null,
    showCode: null,
  ...
  setup(t) {
    const n = t, e = F(), { isCodeFold: c, setCodeFold: l } = S(), { clickCopy: v } = U(), h = _(decodeURIComponent(n.code)), m = _(decodeURIComponent(n.showCode)), C = _(null), d = () => {
      v(h.value), E.open();
    }, L = B(() => {
      var s;
    ...
    return A(() => {
      ...
      class: r([o(e).e("element-plus__container")])
    }, [
      i("section", {
        class: r([o(e).bem("preview")])
      }, [
      ...
      i("section", {
        ...
        i("div", {
          ...
          o(c) ? (a(), y(N, {
            key: 1,
            onClick: u[1] || (u[1] = (f) => o(l)(!1))
          })) : (a(), y(I, {
            key: 0,
            onClick: u[0] || (u[0] = (f) => o(l)(!0))
          })),
          x(D, { onClick: d })
        ], 2)
      ], 2),
...
const Le = ["innerHTML"], He = /* @__PURE__ */ $({
  __name: "NaiveUI",
  props: {
    code: null,
    showCode: null,
  ...
  setup(t) {
    ...
    return A(() => {
      ...
      class: r([o(e).e("naive-ui__container")])
    }, [
      i("section", {
        class: r([o(e).bem("name_handle")])
      }, [
        n.title ? (a(), p("div", {
          key: 0,
          class: r([o(e).bem("component", "name")])
        }, k(t.title), 3)) : H("", !0),
        i("div", {
          class: r([o(e).bem("description", "btns")])
        }, [
          x(D, { onClick: d }),
          o(c) ? (a(), y(N, {
            key: 1,
      ...
      n.description ? (a(), p("section", {
        key: 0,
        class: r([o(e).bem("description")])
      }, [
        i("span", null, k(t.description), 1)
      ], 2)) : H("", !0),
      i("section", {
        class: r([o(e).bem("preview")])
      }, [
